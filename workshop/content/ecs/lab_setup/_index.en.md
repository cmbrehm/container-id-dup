...
For this lab, we need to switch to the other **AWS Cloud9** workspace that was created. Let's get started by launching the **AWS Cloud9** console: [AWS Cloud9 console US-EAST-1](https://us-east-1.console.aws.amazon.com/cloud9/home?region=us-east-1)
